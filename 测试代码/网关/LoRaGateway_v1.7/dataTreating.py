...
class DataTreating:
    ...
    def __init__(self):
        self.ser = serial.Serial("/dev/ttyUSB0", 9600, timeout=0.5)     # 选择的串口
    ...
    def Treat(self):
        ...
        if type(self.RX_Packet) == tuple:
            if self.RX_Packet[0] == b'SENSOR':
                self.testList[self.RX_Packet[1]] += 1
            elif self.RX_Packet[0] == b'STOPTX':
	    print(self.testList)
                ...
                self.testList[self.RX_Packet[1]] = 0
