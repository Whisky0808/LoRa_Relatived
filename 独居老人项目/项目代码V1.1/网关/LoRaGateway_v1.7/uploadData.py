...
class UploadData:
    ...
    def http_put(self, information):
        ...
        isFall = bool(information['isFall'])
        isCure = bool(information['isCure'])
        # 获取当前时间
        ...
        payload_data_isFall = {
            'datastreams': [{"id": "isFall", "datapoints": [{"at": curTime.isoformat(), "value": isFall}]}]}
        payload_data_isCure = {
            'datastreams': [{"id": "isCure", "datapoints": [{"at": curTime.isoformat(), "value": isCure}]}]}
